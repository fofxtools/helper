 ...
 * @param    boolean     $return_as_absolute  If true, returns an absolute value rather than the net difference.
 * @param    boolean     $convert_to_days     If true, returns as fraction of number of days instead of microseconds
 * @return   float
 * @throws   \Exception
 * @see      datetime_diff()
 * @see      convert_to_days()
